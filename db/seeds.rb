...
unless Race.where(:name => 'Human').exists?
  ...
  human.add_image({
    :image_url => '/images/races/humans.jpg',
    :thumb_url => '/images/races/humans-small.jpg',
    :is_primary => true
  })
end
...
unless Race.where(:name => 'Dwarf').exists?
  ...
  dwarf.add_image({
    :image_url => '/images/races/dwarf-male.jpg',
    :thumb_url => '/images/races/dwarf-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
end
...
unless Race.where(:name => 'Elf').exists?
  ...
  elf.add_image({
    ...
    :thumb_url => '/images/races/elves-small.jpg',
    :is_primary => true
  })
end
...
unless Race.where(:name => 'Halfling').exists?
  ...
  halfling.add_image({
    :image_url => '/images/races/halfling-male.jpg',
    :thumb_url => '/images/races/halfling-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
end
...
#  barbarian.add_image({
#    :image_url => '/images/classes/barbarian-male.jpg',
#    :thumb_url => '/images/classes/barbarian-male-small.jpg',
#    :gender => 'male',
#    :is_primary => true
#  })
  barbarian.add_image({
    :image_url => '/images/classes/barbarian-female.jpg',
    :thumb_url => '/images/classes/barbarian-female-small.jpg',
    :gender => 'female',
    :is_primary => true
  })
#  barbarian.add_image({
#    :image_url => '/images/classes/barbarians.jpg',
#    :thumb_url => '/images/classes/barbarians-small.jpg',
#    :is_primary => true
#  })
end
...
unless Character.where(:name => 'Bard').exists?
  ...
  bard.add_image({
    :image_url => '/images/classes/bard-male.jpg',
    :thumb_url => '/images/classes/bard-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
#  bard.add_image({
#    :image_url => '/images/classes/bard-female.jpg',
#    :thumb_url => '/images/classes/bard-female-small.jpg',
#    :gender => 'female',
#    :is_primary => true
#  })
#  bard.add_image({
#    :image_url => '/images/classes/bards.jpg',
#    :thumb_url => '/images/classes/bards-small.jpg',
#    :is_primary => true
#  })
end
...
#  cleric.add_image({
#    :image_url => '/images/classes/cleric-male.jpg',
#    :thumb_url => '/images/classes/cleric-male-small.jpg',
#    :gender => 'male',
#    :is_primary => true
#  })
  cleric.add_image({
    :image_url => '/images/classes/cleric-female.jpg',
    :thumb_url => '/images/classes/cleric-female-small.jpg',
    :gender => 'female',
    :is_primary => true
  })
#  cleric.add_image({
#    :image_url => '/images/classes/clerics.jpg',
#    :thumb_url => '/images/classes/clerics-small.jpg',
#    :is_primary => true
#  })
end
...
#  druid.add_image({
#    :image_url => '/images/classes/druid-male.jpg',
#    :thumb_url => '/images/classes/druid-male-small.jpg',
#    :gender => 'male',
#    :is_primary => true
#  })
  druid.add_image({
    :image_url => '/images/classes/druid-female.jpg',
    :thumb_url => '/images/classes/druid-female-small.jpg',
    :gender => 'female',
    :is_primary => true
  })
#  druid.add_image({
#    :image_url => '/images/classes/druids.jpg',
#    :thumb_url => '/images/classes/druids-small.jpg',
#    :is_primary => true
#  })
end
...
unless Character.where(:name => 'Fighter').exists?
  ...
  fighter.add_image({
    :image_url => '/images/classes/fighter-male.jpg',
    :thumb_url => '/images/classes/fighter-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
#  fighter.add_image({
#    :image_url => '/images/classes/fighter-female.jpg',
#    :thumb_url => '/images/classes/fighter-female-small.jpg',
#    :gender => 'female',
#    :is_primary => true
#  })
#  fighter.add_image({
#    :image_url => '/images/classes/fighters.jpg',
#    :thumb_url => '/images/classes/fighters-small.jpg',
#    :is_primary => true
#  })
end
...
unless Character.where(:name => 'Monk').exists?
  ...
  monk.add_image({
    :image_url => '/images/classes/monk-male.jpg',
    :thumb_url => '/images/classes/monk-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
#  monk.add_image({
#    :image_url => '/images/classes/monk-female.jpg',
#    :thumb_url => '/images/classes/monk-female-small.jpg',
#    :gender => 'female',
#    :is_primary => true
#  })
#  monk.add_image({
#    :image_url => '/images/classes/monks.jpg',
#    :thumb_url => '/images/classes/monks-small.jpg',
#    :is_primary => true
#  })
end
...
#  paladin.add_image({
#    :image_url => '/images/classes/paladin-male.jpg',
#    :thumb_url => '/images/classes/paladin-male-small.jpg',
#    :gender => 'male',
#    :is_primary => true
#  })
  paladin.add_image({
    :image_url => '/images/classes/paladin-female.jpg',
    :thumb_url => '/images/classes/paladin-female-small.jpg',
    :gender => 'female',
    :is_primary => true
  })
#  paladin.add_image({
#    :image_url => '/images/classes/paladins.jpg',
#    :thumb_url => '/images/classes/paladins-small.jpg',
#    :is_primary => true
#  })
end
...
unless Character.where(:name => 'Ranger').exists?
  ...
  ranger.add_image({
    :image_url => '/images/classes/ranger-male.jpg',
    :thumb_url => '/images/classes/ranger-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
#  ranger.add_image({
#    :image_url => '/images/classes/ranger-female.jpg',
#    :thumb_url => '/images/classes/ranger-female-small.jpg',
#    :gender => 'female',
#    :is_primary => true
#  })
#  ranger.add_image({
#    :image_url => '/images/classes/rangers.jpg',
#    :thumb_url => '/images/classes/rangers-small.jpg',
#    :is_primary => true
#  })
end
...
#  rogue.add_image({
#    :image_url => '/images/classes/rogue-male.jpg',
#    :thumb_url => '/images/classes/rogue-male-small.jpg',
#    :gender => 'male',
#    :is_primary => true
#  })
  rogue.add_image({
    :image_url => '/images/classes/rogue-female.jpg',
    :thumb_url => '/images/classes/rogue-female-small.jpg',
    :gender => 'female',
    :is_primary => true
  })
#  rogue.add_image({
#    :image_url => '/images/classes/rogues.jpg',
#    :thumb_url => '/images/classes/rogues-small.jpg',
#    :is_primary => true
#  })
end
...
#  sorcerer.add_image({
#    :image_url => '/images/classes/sorcerer-male.jpg',
#    :thumb_url => '/images/classes/sorcerer-male-small.jpg',
#    :gender => 'male',
#    :is_primary => true
#  })
  sorcerer.add_image({
    :image_url => '/images/classes/sorcerer-female.jpg',
    :thumb_url => '/images/classes/sorcerer-female-small.jpg',
    :gender => 'female',
    :is_primary => true
  })
#  sorcerer.add_image({
#    :image_url => '/images/classes/sorcerers.jpg',
#    :thumb_url => '/images/classes/sorcerers-small.jpg',
#    :is_primary => true
#  })
end
...
unless Character.where(:name => 'Wizard').exists?
  ...
  wizard.add_image({
    :image_url => '/images/classes/wizard-male.jpg',
    :thumb_url => '/images/classes/wizard-male-small.jpg',
    :gender => 'male',
    :is_primary => true
  })
#  wizard.add_image({
#    :image_url => '/images/classes/wizard-female.jpg',
#    :thumb_url => '/images/classes/wizard-female-small.jpg',
#    :gender => 'female',
#    :is_primary => true
#  })
#  wizard.add_image({
#    :image_url => '/images/classes/wizards.jpg',
#    :thumb_url => '/images/classes/wizards-small.jpg',
#    :is_primary => true
#  })
end
